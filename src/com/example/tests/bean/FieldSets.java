...
public class FieldSets {
	...
	public FieldSets(){
		String []titles={"problem_id(改数列没数据整行作废说)","description","result(未解决(尚未处理)、未解决(延后解决)、未解决(无法解决)、未解决(不需解决)、未解决(无法重现)、解决(修复成功)、解决(不是缺陷)、解决(重复缺陷))","problemSolution","problemComment","assignUser( null for yourself)","assignComment"};
